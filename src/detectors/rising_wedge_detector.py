...
class RisingWedgeDetector(BaseDetector):
    ...
    def _identify_rising_wedge(
        ...
        try:
            ...
            trendline_price_at_end = self._calculate_trendline_price(
                lower_trendline, end_idx - start_idx
            )
    ...
    def _create_rising_wedge_signal(
        ...
        try:
            ...
            upper_trendline_price = self._calculate_trendline_price(
            ...
            confidence = self._calculate_rising_wedge_confidence(
    ...
    def _calculate_rising_wedge_confidence(
        self, pattern_info: Dict[str, Any], data: pd.DataFrame, end_idx: int
    ) -> float:
