...
class PluginManager:
    ...
    def __init__(
        self, plugin_dir: str = "plugins", registry: Optional[PluginRegistry] = None
    ):
    ...
    def load_plugin_from_file(
        ...
        try:
            ...
            self.logger.info(
                f"Plugin '{plugin_name}' loaded successfully from {plugin_path}"
            )
    ...
    def _register_plugin_classes(self, module, plugin_name: str):
        ...
        for name, obj in inspect.getmembers(module):
            if inspect.isclass(obj):
                ...
                if (
                    issubclass(obj, EnhancedPatternDetector)
                    and obj != EnhancedPatternDetector
                ):
                    self.registry.register_detector(
