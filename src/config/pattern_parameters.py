...
class PatternParameters:
    ...
    def update_detector_params(self, detector_name: str, params: Dict[str, Any]) -> None:
    ...
    def from_dict(cls, data: Dict[str, Dict[str, Any]]) -> 'PatternParameters':
        ...
        return cls(
            ...
            triangle_detector=data.get('triangle_detector', cls._get_default_triangle_params()),
    ...
    def validate(self) -> List[str]:
        ...
        if vcp_params.get('max_decline_threshold', 0) > vcp_params.get('min_decline_threshold', -1):
            errors.append("VCP max_decline_threshold should be less than min_decline_threshold")
        
        # Validate Flag parameters
        flag_params = self.flag_detector
        if flag_params.get('flag_max_duration', 0) < flag_params.get('flag_min_duration', 0):
        ...
        if triangle_params.get('triangle_max_length', 0) < triangle_params.get('triangle_min_length', 0):
        ...
        if wedge_params.get('wedge_max_length', 0) < wedge_params.get('wedge_min_length', 0):
